...
$\mathcal{D}_E = (3/2)(1-w)$ joining three physical faces: **dusk** (dark energy without Λ; [Paper III / SEDE cosmology,
Zenodo DOI to be assigned]), **dawn** (this paper), and **galactic** (a MOND readout; Paper VIII, not yet
drafted). The scale sector [Paper VI / scale sector, Zenodo DOI to be assigned] sets the mass scales that this
...
The results above reproduce from the accompanying analysis scripts in <https://github.com/spsingularity/eccg-matter-genesis>. Key scripts and reports:
...
Companion papers: [Paper III / SEDE cosmology, Zenodo DOI to be assigned], [Paper V / USC framework, Zenodo DOI
to be assigned], [Paper VI / scale sector, Zenodo DOI to be assigned], [Paper VIII / APDM galactic, in
preparation].
