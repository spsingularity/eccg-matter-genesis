#!/usr/bin/env bash
# Build the JHEP-class PDF (jheppub) for Paper VII from ECCG_matter_genesis.md.
...
# make long monospace paths (file paths in Reproducibility) breakable: insert \allowbreak after / . _
